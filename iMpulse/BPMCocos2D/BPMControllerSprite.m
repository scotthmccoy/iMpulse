...
{
    //Media Keys
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(observer_NOTIFICATION_PLAYPAUSE_PRESS:) name:@"NOTIFICATION_PLAYPAUSE_PRESS" object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(observer_NOTIFICATION_PREVIOUSTRACK_PRESS:) name:@"NOTIFICATION_PREVIOUSTRACK_PRESS" object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(observer_NOTIFICATION_NEXTTRACK_PRESS:) name:@"NOTIFICATION_NEXTTRACK_PRESS" object:nil];
